...
class ThermometerWidget(QtWidgets.QWidget):
    ...
    def drawBackground(self, painter):
        ...
        linearGrad.setColorAt(1.0, QtGui.QColor(0, 150, 255, 170))  # blue, outside color
        linearGrad.setColorAt(0.0, QtGui.QColor(255, 255, 255, 255))  # white, inside color
        ...
        pen = QtGui.QPen()
        pen.setColor(QtCore.Qt.red)  # value's color
        length = 12
        ...
        for i in range(9):
            ...
            val = "{0:g}".format(num)  # {0} to have .0s
